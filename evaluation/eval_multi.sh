...
DATA_NAMES=("math-500,gsm8k,minerva_math,olympiadbench")
...
MODEL_DIRS=(
    '/home/yifan50/rl/deepscaler/output/models/final_teacher/test_replay_prob_random_teacher_model_Qwen2.5-Math-7B_dataset_deepmath_8192_epoch_30_bs_512_lr_1e-6_beta_0_entropy_0_mu_2_tau_1e-3_alpha_0.5_sigma_0.5_buffer_256'
)
